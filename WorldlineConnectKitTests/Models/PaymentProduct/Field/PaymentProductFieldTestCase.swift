...
class PaymentProductFieldTestCase: XCTestCase {
    ...
    func testDisplayHints() {
        XCTAssertFalse(field.displayHints?.alwaysShow == true, "Expected alwaysShow to be false")
        ...
        XCTAssertFalse(field.displayHints?.obfuscate == true, "Expected obfuscate to be false")
